...
Backport of the upstream Apertus tool parser (added in vLLM v0.22.0,
byte-identical through v0.24) onto this v0.19-based tree, whose module
layout it already matches.
"""
